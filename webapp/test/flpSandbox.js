		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData project",
									"targetURL": "#josecaveroodatapodataproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"josecaveroodatapodataproject-display": {
								"semanticObject": "josecaveroodatapodataproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jose.cavero.odatap.odataproject",
									"url": sap.ui.require.toUrl("jose/cavero/odatap/odataproject")
								}
							}
						}
					}
